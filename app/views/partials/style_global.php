        ...
        *, *::before, *::after {
        ...
        .export-toast.progress-toast .txt {
        ...
        .export-toast-progress {
            ...
            overflow: hidden;
            border-radius: 999px;
            background: color-mix(in srgb, var(--ab-border) 45%, transparent);
        }
        ...
        .export-toast-progress.is-indeterminate span {
            width: 42%;
            animation: export-progress-indeterminate 1.15s ease-in-out infinite;
        }
        .export-toast-status {
            width: 100%;
            color: var(--ab-muted);
        ...
        .app-toast[data-type="warning"] .app-toast-icon,
        .app-alert-modal[data-type="warning"] .app-alert-modal-icon {
            background: linear-gradient(135deg, #f97316, #fb923c);
            box-shadow: 0 12px 24px rgba(249, 115, 22, 0.28);
        }
        .app-toast[data-type="danger"] .app-toast-icon,
        .app-alert-modal[data-type="danger"] .app-alert-modal-icon {
            background: linear-gradient(135deg, #dc2626, #ef4444);
        ...
        .app-inline-note.is-warning {
            border-color: color-mix(in srgb, #f97316 42%, var(--ab-border) 58%);
            background: color-mix(in srgb, #f97316 10%, var(--ab-card) 90%);
        }
        .app-inline-note.is-info,
        .app-inline-note.is-secondary {
            border-color: color-mix(in srgb, #0891b2 30%, var(--ab-border) 70%);
            background: color-mix(in srgb, #0891b2 8%, var(--ab-card) 92%);
        }
        .app-inline-note.is-danger {
            border-color: color-mix(in srgb, #dc2626 38%, var(--ab-border) 62%);
            background: color-mix(in srgb, #dc2626 8%, var(--ab-card) 92%);
        }
        .app-inline-note.is-success {
            border-color: color-mix(in srgb, #16a34a 36%, var(--ab-border) 64%);
            background: color-mix(in srgb, #16a34a 8%, var(--ab-card) 92%);
        }
        .app-confirm-wrap {
            position: fixed;
            inset: 0;
        ...
        /* Contextual user guide (first use per page) */
        .tour-overlay {
            position: fixed;
            inset: 0;
            z-index: 2147483000;
        ...
        .tour-note {
            ...
            border-radius: 12px;
            border: 1px solid color-mix(in srgb, var(--ab-accent) 24%, var(--ab-border) 76%);
...
<?php require __DIR__ . '/style_button_contrast.php'; ?>
...
<?php require __DIR__ . '/style_visual_hardening.php'; ?>
        ...
        .saas-page.is-ajax-loading,
        .reports-page.is-ajax-loading {
            pointer-events: none;
        }
        .app-content.is-ajax-loading::after,
        .saas-page.is-ajax-loading::after,
        .reports-page.is-ajax-loading::after {
            content: "Atualizando...";
            position: fixed;
            right: 1.25rem;
            bottom: 1.25rem;
...
<?php require __DIR__ . '/style_logout_forms.php'; ?>
