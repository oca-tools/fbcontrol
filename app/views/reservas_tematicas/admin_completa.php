...
<div class="card config-card p-4 mb-4">
    ...
    <div class="closure-actions-grid">
        <div class="closure-panel">
            ...
            <form method="post" action="/?r=reservasTematicas/adminCompleta" class="closure-form-grid">
        ...
        <?php if (!empty($bloqueiosData)): ?>
            <div class="closure-list-grid">
                <?php foreach ($bloqueiosData as $bloqueio): ?>
                    ...
                    <form method="post" action="/?r=reservasTematicas/adminCompleta" class="closure-card d-flex justify-content-between align-items-center gap-2">
                        <input type="hidden" name="csrf_token" value="<?= h(csrf_token()) ?>">
                        <input type="hidden" name="action" value="bloqueio_data">
...
<div class="card config-card p-4 mb-4">
    ...
    <form method="post" action="/?r=reservasTematicas/adminCompleta" class="capacity-settings-form">
        <input type="hidden" name="csrf_token" value="<?= h(csrf_token()) ?>">
...
(() => {
    ...
    picker.addEventListener('change', async () => {
        ...
        try {
            const res = await fetch(`/?r=reservasTematicas/adminCompleta&ajax=capacity_date&cap_data=${encodeURIComponent(date)}`, {
...
<div class="card config-card p-4 mb-4">
    ...
    <form method="post" action="/?r=reservasTematicas/adminCompleta" class="schedule-editor-form">
        <input type="hidden" name="csrf_token" value="<?= h(csrf_token()) ?>">
    ...
    <hr class="my-4">
    <form method="post" action="/?r=reservasTematicas/adminCompleta" class="row g-2 align-items-end schedule-add-form">
        <input type="hidden" name="csrf_token" value="<?= h(csrf_token()) ?>">
